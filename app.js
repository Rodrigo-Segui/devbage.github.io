...
mongoose.connect(`mongodb+srv://${process.env.DB_USER}:${process.env.DB_COLECTION}@${process.env.DB_HOST}:${process.env.DB_PORT}/${process.env.DB_COLECTION}?retryWrites=true&w=majority`, { useNewUrlParser: true, useUnifiedTopology: true })
  .catch(err => {
    console.log(err)
  })
